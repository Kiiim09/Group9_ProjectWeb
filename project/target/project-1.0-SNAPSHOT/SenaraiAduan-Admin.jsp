<%-- 
    Document   : SenaraiAduan-Admin
    Created on : 26 Jun 2024, 4:03:17 am
    Author     : User
--%>
...
<body>
    ...
    <div class="container">
        ...
        <form method="get" action="ComplaintListServlet">
            <input type="hidden" name="pageSource" value="Admin">
            ...
            <tbody>
                <c:forEach var="complaint" items="${complaintList}">
                    <tr>
                        ...
                        <td><a href="KemaskiniAduan-Admin.jsp?id=${complaint.id}">EDIT</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
