<%-- 
    Document   : SenaraiAduan-Pelajar
    Created on : 26 Jun 2024, 4:03:38 am
    Author     : User
--%>
...
<head>
    ...
    <title>Senarai Aduan Pelajar</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <form method="get" action="ComplaintListServlet">
            <input type="hidden" name="pageSource" value="Pelajar">
            ...
            <tbody>
                <c:forEach var="complaint" items="${complaintList}">
                    <tr>
                        ...
                        <<td><a href="complaintDetails?id=${complaint.id}">LIHAT</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
