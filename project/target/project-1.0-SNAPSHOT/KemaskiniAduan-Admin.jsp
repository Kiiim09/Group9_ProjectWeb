<%-- 
    Document   : KemaskiniAduan-Admin
    Created on : 28 Jun 2024, 12:05:28 am
    Author     : User
--%>
...
<head>
    <meta charset="UTF-8">
    <title>Kemaskini Aduan Admin</title>
    <style>
        body {
...
<body>
    <div class="sidenav">
        <a align="center" href="SenaraiAduan-Admin.jsp"><img id="logo" style="width: 100px;" src="images/logo.png" alt="logo"/></a>
        <h2>Kemaskini Aduan</h2>
        <a href="SenaraiAduan-Admin.jsp">Senarai Aduan</a>
    </div>
    
    <div class="container">
        <h1>Kemaskini Aduan</h1>
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form action="updateComplaint" method="post"  var="complaint" items="${complaintList}">
